    ...
    public static class Utils
    {
        ...
        public static string GetTempPath()
        {
            if (_tempPath == null)
            {
                try
                {
                    //_tempPath = Directory.CreateDirectory(Path.Combine(Path.GetTempPath(), @"Exchanger\ss_win_temp_" + Application.ExecutablePath.GetHashCode())).FullName;
        ...
        public static string ConvertTimestamp2DatetimeShortStr(long timestamp)
        {
            return ConvertTimestamp2DatetimeStr(timestamp, "HH:mm:ss");
        }

        public static string ConvertTimestamp2DatetimeStr(long timestamp, string dateformat)
        {
