...
namespace exchanger.Util
{
    public class HttpClient
    {
        ...
        private string postingDataJson = null;
        #endregion
        ...
        public string PostingDataJson
        {
            get { return postingDataJson; }
            set { postingDataJson = value; }
        }
        ...
        private HttpWebRequest CreateRequest()
        {
            ...
            if (postingData.Count > 0 || files.Count > 0 || !string.IsNullOrEmpty(postingDataJson))
                verb = HttpVerb.POST;
            ...
            if (verb == HttpVerb.POST)
            {
                ...
                else
                {
                    ...
                    if (string.IsNullOrEmpty(postingDataJson))
                    {
